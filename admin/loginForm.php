 ...
 <div class="bg-white p-32 border-r border-t border-b border-gray-600 rounded-r-lg shadowlg">
    <form action="loginFunction.php" method="post">
      <div class="flex items-center mb-4">
        ...
        <input type="text" id="username" name="uname" class="w-full p-2 pl-10 border border-gray-300 rounded-lg" placeholder="Username">
      </div>
      <div class="flex items-center mb-4">
        <i class="fas fa-lock text-gray-500 mr-2"></i>
        <input type="password" id="password" name="pass" class="w-full p-2 pl-10 border border-gray-300 rounded-lg" placeholder="Password">
      </div>
      <div class="flex items-center mb-4">
